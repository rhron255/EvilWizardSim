...
export const anyOffers: Offer[] = [
  {
    ...
    options: [
      ...
      },
      {
        ...
        failureText: 'It was not the pipes. It was polite about being drunk, which is worse.',
      },
    ],
  },
...

  {
    ...
    options: [
      ...
      },
      {
        ...
        failureText: 'It is loose in the courtyard now. The courier has you sign the second form.',
      },
    ],
  },
...

  {
    ...
    options: [
      ...
      },
      {
        ...
        successText: 'They hear you out and amend their notes. You are given a jar and a title.',
        failureText: 'They finish their notes. The Choir receives a copy before you do.',
      },
    ],
  },

  {
    ...
    options: [
      ...
      },
      {
        ...
        successText: 'The work is sound. The thirty per cent remains unexplained.',
...

  {
    ...
    options: [
      ...
      },
      {
        ...
        successText: 'You identify the room. You have been standing in it for some time.',
        failureText: 'You come back through the wrong side, and something took the angle you left.',
      },
    ],
  },
...

  {
    ...
    options: [
      ...
      },
      {
        ...
        successText: 'The new one is still there in the spring. The steward stops asking about it.',
        failureText: 'Neither returns. Next year’s count is shorter by one more.',
      },
    ],
  },

  {
    ...
    options: [
      ...
      },
      {
        ...
        successText: 'The fourth divination works. The Academy would like the cat, and will trade.',
